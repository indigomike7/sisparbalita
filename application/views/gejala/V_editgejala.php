            ...
            <div class="col-md-12">
                <form class="form-group" method="post" action="">
                    ...
                    <div class="form-group">
                        <label for="formGroupExampleInput2">Kode</label><br>
                        <small class="text-danger">Masukkan Kode Gejala Motorik !</small>
                        <input type="text" class="form-control col-md-4" name="kode" id="kode" placeholder="kode" value="<?= $gejala['kode']; ?>">
                        <?= form_error('kode', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput">Gerak Motorik</label>
                        <input type="text" class="form-control" name="gejala" id="gejala" placeholder="Masukkan Gerak Motorik Balita" value="<?= $gejala['nama_ciri']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control col-md-4" name="umur" id="umur" placeholder="Umur" value="<?= $gejala['umur']; ?>">
