                    ...
                    <tbody>
                        ...
                        foreach ($macam as $row) { ?>
                            <tr>
                                ...
                                <td>
                                    <a title="Edit Data" href="<?= base_url('pertumbuhan/edit/') . $row['id_pertumbuhan']; ?>" class="btn btn-circle btn-outline-primary"><i class="fas fa-edit"></i></a>

                                    <a title="Hapus Data" href="<?= base_url('pertumbuhan/hapus/') . $row['id_pertumbuhan']; ?>" class="btn btn-circle btn-outline-danger" onclick="return confirm('Anda yakin menghapus data ini ?');"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php }; ?>
                    </tbody>
